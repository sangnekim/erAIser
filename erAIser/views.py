...
def result(request):
    if request.POST:
        ...
        shutil.rmtree(os.path.join(BASE_DIR, "media/video/"))
        shutil.rmtree(os.path.join(BASE_DIR, "media/rst/"))
        shutil.rmtree(os.path.join(BASE_DIR, "media/image/"))
        shutil.rmtree(os.path.join(BASE_DIR, "media/src_img/"))

        os.mkdir(os.path.join(BASE_DIR, "media/rst"))
        os.mkdir(os.path.join(BASE_DIR, "media/src_img"))
        os.mkdir(os.path.join(BASE_DIR, "media/video"))
